...
<main class="contenedor seccion">
    ...
    <div class="contenido-nosotros">
        <div class="imagen">
            <picture>
                <source srcset="<?php echo RUTA_IMGICO . 'nosotros.webp'; ?>" type="image/webp">
                <source srcset="<?php echo RUTA_IMGICO . 'nosotros.jpg'; ?>" type="image/jpeg">
                <img loading="lazy" src="<?php echo RUTA_IMGICO . 'nosotros.jpg'; ?>" alt="Sobre Nosotros">
            </picture>
        </div>
