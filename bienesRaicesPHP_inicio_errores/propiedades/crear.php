...
//$row_vend = mysqli_fetch_array($recno_vend, MYSQLI_ASSOC);
...
<main class="contenedor seccion">
    ...
    <form class="formulario" method="POST" action="<?php echo 'admin\propiedades\crear.php' ?>" enctype="multipart/form-data">
        <fieldset>
